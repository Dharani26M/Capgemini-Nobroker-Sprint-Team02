Feature: Combined Functionalities - Blog, AC Repair, Home Repair, Rental, Shortlist
 @Blog
  ...
  Scenario: Shortlisting properties
    ...
    And clicks shortlistFeature: Combined Functionalities - Blog, AC Repair, Home Repair, Rental, Shortlist
 @Blog
  Scenario Outline: User subscribes to blog successfully
...
@Rental
  ...
  Scenario: Verify user can trigger login in AC repair
    ...
    And Add AC service
    Then payment page should be displayed verifiedFeature: Combined Functionalities - Blog, AC Repair, Home Repair, Rental, Shortlist
 @Blog
  Scenario Outline: User subscribes to blog successfully
