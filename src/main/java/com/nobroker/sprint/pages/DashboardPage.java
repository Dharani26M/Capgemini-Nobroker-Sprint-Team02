...
public class DashboardPage {
    ...
    // Getters
    public WebElement getPackersAndMovers() { return PackersAndMovers; }
    public WebElement getCityDropdown() { return cityDropdown; }
    public WebElement getSearchBtn() { return SearchBtn; }
    public WebElement getMenuField() { return MenuField; }
    public WebElement getPostProperty() { return PostProperty; }
    public WebElement getRentReceipts() { return RentReceipts; }
    public WebElement getReferEarn() { return ReferEarn; }
    public WebElement getPaintingsCleaning() { return PaintingsCleaning; }
    ...
    public WebElement getNewIcon() { return NewIcon; }
    public WebElement getProfileImg() { return ProfileImg; }
    public WebElement getProfileFeature() { return ProfileFeature; }
    public WebElement getBuyHouse() { return buy; }
    public WebElement getLocality() { return locality; }
